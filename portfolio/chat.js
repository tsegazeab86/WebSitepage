...
document.addEventListener("DOMContentLoaded", function () {
  // ========== TYPING ANIMATION ==========
  const typedTextSpan = doc.querySelector(".typed-text");
  const cursorSpan = doc.querySelector(".cursor");
  const textArray = [
    "Front-End Developer",
    "UI/UX Designer",
    "Web Developer",
  ...
  const navLink = doc.querySelector(".nav-links");
  ...
  function animateSkillBars() {
    const skillLevels = doc.querySelectorAll(".skill-level");
  ...
  const projectsData = [
    {
      ...
      description:
        "A fully responsive e-commerce platform with shopping cart, product filtering, and payment integration.",
      image:
    ...
    },
    {
      ...
      title: "Weather App",
      description:
        "Real-time weather application with location detection and 7-day forecast using OpenWeather API.",
      image:
    ...
    },
    {
      ...
      title: "Task Manager",
      description:
        "Productivity app with drag-and-drop functionality, task categorization, and progress tracking.",
      image:
    ...
    },
    {
      ...
      description:
        "Mobile application for tracking workouts, calories, and progress with interactive charts.",
      image:
    ...
    },
    {
      ...
      description:
        "Modern portfolio website with dark/light mode, animations, and responsive design.",
      image:
    ...
    },
    {
      ...
      title: "Recipe Finder",
      description:
        "Web application for finding recipes by ingredients with step-by-step instructions.",
      image:
  ...
  function renderProjects(filter = "all") {
    ...
    filteredProjects.forEach((project) => {
      const projectCard = doc.createElement("div");
  ...
  const newsletterForm = doc.querySelector(".newsletter-form");
  ...
  const animateOnScroll = () => {
    const elements = doc.querySelectorAll(
      ".about-content, .skills-category, .project-card",
    );
  ...
  doc
    .querySelectorAll(".about-content, .skills-category, .project-card")
    .forEach((element) => {
  ...
  doc.querySelector(".nav-container").appendChild(themeToggle);

  themeToggle.addEventListener("click", () => {
    doc.body.classList.toggle("dark-mode");
    themeToggle.innerHTML = doc.body.classList.contains("dark-mode")
